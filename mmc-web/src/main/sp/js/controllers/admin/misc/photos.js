...
.controller('adminMiscPhotosCtrl',['$scope', 'utils', 'photoService', '$timeout', '$modal', function($scope, utils, imgService, $timeout, $modal) {
 ...
 $scope.getPhotos = function () {
  ...
  imgService.getPhotos(null, null, 'misc', function(response) {
...
angular.module('mmcApp').controller('popupMiscPhotoCtrl', function($scope, $location, $timeout, $modalInstance, utils, musicService, refValues, datas) {
 $scope.DELAY = 5;
